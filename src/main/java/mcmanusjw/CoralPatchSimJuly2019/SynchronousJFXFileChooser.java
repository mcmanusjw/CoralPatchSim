 ...
 *
 * A utility class that summons JavaFX FileChooser from the Swing EDT (Event Dispatch Thread).
...
public class SynchronousJFXFileChooser 
{
     ...
     */
    public <T> T showDialog
    ( 
    	Function<FileChooser, T> method,
    ...
    /**
     * Use this below only for testing
     * 
     */
